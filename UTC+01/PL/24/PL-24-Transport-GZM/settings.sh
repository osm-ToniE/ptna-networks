...
WIKI_ROUTES_PAGE="Śląskie/Komunikacja_miejska/Analysis/Zarząd_Transportu_Metropolitalnego/Transport_GZM_Linie"

ANALYSIS_OPTIONS="--timezone=$PTNA_TIMEZONE --language=pl_PL --check-gtfs --link-gtfs --show-gtfs --gtfs-feed=PL-24-ZTM-Katowice --max-error=10 --check-access --check-dates --check-way-type --check-service-type --check-name-relaxed --check-stop-position --check-sequence --check-version --check-osm-separator --check-motorway-link --expect-network-long-for=ZTM --multiple-ref-type-entries=analyze --positive-notes --coloured-sketchline --relaxed-begin-end-for=train,subway,light_rail,monorail,tram"
...
PTNA_WWW_REGION_NAME="Górnośląsko-Zagłębiowska Metropolia"
...
PTNA_WWW_NETWORK_NAME="Transport GZM"
PTNA_WWW_NETWORK_LINK="https://transportgzm.pl/"
...
PTNA_WWW_ROUTES_NAME="Transport GZM Linie"
