...
PTNA_EXTRACT_SOURCE="austria.osm.pbf"
...
OVERPASS_QUERY="https://overpass-api.de/api/interpreter?data=area[wikidata='Q40'][type=boundary];(rel(area)[~'route'~'(train|light_rail|monorail)'];rel(br);rel[~'type'~'route'](r);)->.routes;(.routes;<<;rel(r.routes);way(r);node(w);way(r.routes);node(w);node(r.routes););out;"
NETWORK_LONG=""
NETWORK_SHORT=""

ANALYSIS_PAGE="Austria/Eisenbahnverkehr/Analyse"
ANALYSIS_TALK="Talk:Austria/Eisenbahnverkehr/Analyse"
WIKI_ROUTES_PAGE="Austria/Eisenbahnverkehr/Analyse/Eisenbahn-Linien"
...
PTNA_WWW_REGION_NAME="Österreich"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B(relation[wikidata='Q40'][type=boundary]%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Alle Linien"
...
PTNA_WWW_ROUTES_NAME="Bahnlinien in AT"
