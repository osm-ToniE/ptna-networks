...
PREFIX="FR-IDF-poissy-les-mureaux"
...
NETWORK_LONG=""
NETWORK_SHORT="Poissy - Les Mureaux"
...
PTNA_WWW_NETWORK_LINK="https://www.iledefrance-mobilites.fr/actualites/locales/poissy-les-mureaux"
