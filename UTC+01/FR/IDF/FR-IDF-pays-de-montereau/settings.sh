...
PREFIX="FR-IDF-pays-de-montereau"
...
NETWORK_LONG=""
NETWORK_SHORT="Pays de Montereau"
...
PTNA_WWW_NETWORK_LINK="https://www.iledefrance-mobilites.fr/actualites/locales/pays-de-montereau"
