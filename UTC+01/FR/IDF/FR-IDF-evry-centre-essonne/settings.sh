...
PREFIX="FR-IDF-evry-centre-essonne"
...
NETWORK_LONG=""
NETWORK_SHORT="Evry Centre Essonne"
...
PTNA_WWW_NETWORK_LINK="https://www.iledefrance-mobilites.fr/actualites/locales/evry-centre-essonne"
