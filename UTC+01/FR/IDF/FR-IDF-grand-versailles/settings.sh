...
PREFIX="FR-IDF-grand-versailles"
...
NETWORK_LONG=""
NETWORK_SHORT="Grand Versailles"
...
PTNA_WWW_NETWORK_LINK="https://www.iledefrance-mobilites.fr/actualites/locales/grand-versailles"
