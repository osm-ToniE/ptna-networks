...
PREFIX="FR-IDF-fontainebleau-moret"
...
NETWORK_LONG=""
NETWORK_SHORT="Fontainebleau - Moret"
...
PTNA_WWW_NETWORK_LINK="https://www.iledefrance-mobilites.fr/actualites/locales/fontainebleau-moret"
