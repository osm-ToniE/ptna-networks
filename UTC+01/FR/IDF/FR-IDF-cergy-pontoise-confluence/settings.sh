...
PREFIX="FR-IDF-cergy-pontoise-confluence"
...
NETWORK_LONG=""
NETWORK_SHORT="Cergy-Pontoise Confluence"
...
PTNA_WWW_NETWORK_LINK="https://www.iledefrance-mobilites.fr/actualites/locales/cergy-pontoise-confluence"
