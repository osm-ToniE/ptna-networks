...
NETWORK_LONG="La Métropole Mobilité|L'Agglo en bus|La Métropole Mobilité - LeBus|La Métropole Mobilité - LeCar|Les Bus de l'Étang|Libébus|Ulysse|Lignes de l'Agglo|Pays d'Aix mobilité|Ciotabus|Envia|Aix-en-Bus"
NETWORK_SHORT=""
