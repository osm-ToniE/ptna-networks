...
ANALYSIS_OPTIONS="--timezone=$PTNA_TIMEZONE --language=fr --check-bus-stop --link-gtfs --gtfs-feed=$PREFIX --max-error=10 --check-access --check-dates --check-way-type --check-service-type --check-name-relaxed --check-stop-position --check-sequence --check-version --check-osm-separator --check-motorway-link --check-platform --check-roundabouts --multiple-ref-type-entries=analyze --coloured-sketchline --relaxed-begin-end-for=train,subway,light_rail,monorail,tram"
...
PTNA_WWW_REGION_NAME="Département Drôme et la ville de Guilherand-Granges, Ardèche"
...
PTNA_WWW_NETWORK_LINK="https://www.montelibus.fr/;https://www.valenceromansmobilites.fr/;https://www.nyons.com/vivre-nyons/transports/transports-collectifs;https://www.laregionvoustransporte.fr/departements/transports-interurbains-de-la-drome"
