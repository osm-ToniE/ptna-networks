...
PTNA_EXTRACT_GETIDS="luxembourg"
...
NETWORK_LONG="Régime Général des Transports Routiers"
NETWORK_SHORT="RGTR"

ANALYSIS_PAGE="WikiProject_Luxembourg/Public_Transport/Analysis/RGTR"
...
PTNA_WWW_NETWORK_NAME="RGTR"
PTNA_WWW_NETWORK_LINK="http://mobiliteit.lu/"
...
PTNA_WWW_ROUTES_NAME="RGTR Lines"
