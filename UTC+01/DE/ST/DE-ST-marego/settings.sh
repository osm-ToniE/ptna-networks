...
OVERPASS_QUERY="https://overpass-api.de/api/interpreter?data=area[type=boundary][boundary=public_transport][name='Magdeburger Regionalverkehrsverbund'];(rel(area)[~'route'~'(bus|tram|train|subway|light_rail|trolleybus|ferry|monorail|aerialway|share_taxi|funicular)'];rel(br);rel[~'type'~'route'](r);)->.routes;(.routes;<<;rel(r.routes);way(r);node(w);way(r.routes);node(w);node(r.routes););out;"
NETWORK_LONG="Magdeburger Regionalverkehrsverbund"
NETWORK_SHORT="marego"

ANALYSIS_PAGE="Magdeburg/ÖPNV/PTNA/Analyse"
ANALYSIS_TALK="Talk:Magdeburg/ÖPNV/PTNA/Analyse"
WIKI_ROUTES_PAGE="Magdeburg/ÖPNV/PTNA/DE-ST-marego-Linien"
...
PTNA_WWW_REGION_NAME="Region Magdeburg"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B(relation[type=boundary][boundary=public_transport][name='Magdeburger Regionalverkehrsverbund']%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Magdeburger Regionalverkehrsverbund"
PTNA_WWW_NETWORK_LINK="https://marego-verbund.de/"
...
PTNA_WWW_ROUTES_NAME="marego Linien"
