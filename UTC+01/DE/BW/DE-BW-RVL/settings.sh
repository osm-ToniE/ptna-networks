...
OVERPASS_QUERY="https://overpass-api.de/api/interpreter?data=area[boundary=administrative][wikidata='Q8198'];(rel(area)[~'route'~'(bus|tram|train|subway|light_rail|trolleybus|ferry|monorail|aerialway|share_taxi|funicular)'];rel(br);rel[~'type'~'route'](r);)->.routes;(.routes;<<;rel(r.routes);way(r);node(w);way(r.routes);node(w);node(r.routes););out;"
NETWORK_LONG="Regio Verkehrsverbund Lörrach|Regio Verkehrsverbund Lörrach GmbH"
NETWORK_SHORT="RVL"

ANALYSIS_PAGE="Regio_Verkehrsverbund_Lörrach/Analyse"
ANALYSIS_TALK="Talk:Regio_Verkehrsverbund_Lörrach/Analyse"
WIKI_ROUTES_PAGE="Regio_Verkehrsverbund_Lörrach/Analyse/DE-BW-RVL-Routes"
...
PTNA_WWW_REGION_NAME="Landkreis Lörrach"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B(relation%5Bboundary%3Dadministrative%5D%5Bwikidata=%22Q8198%22%5D%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Regio Verkehrsverbund Lörrach"
PTNA_WWW_NETWORK_LINK="https://rvl-online.de/"
...
PTNA_WWW_ROUTES_NAME="RVL Linien"
