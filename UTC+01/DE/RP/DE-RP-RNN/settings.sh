...
PTNA_EXTRACT_GETIDS="rhineland-palatinate"

OVERPASS_QUERY="https://overpass-api.de/api/interpreter?data=area[boundary=public_transport][name='Rhein-Nahe Nahverkehrsverbund'];(rel(area)[~'route'~'(bus|tram|train|subway|light_rail|trolleybus|ferry|monorail|aerialway|share_taxi|funicular)'];rel(br);rel[~'type'~'route'](r);)->.routes;(.routes;<<;rel(r.routes);way(r);node(w);way(r.routes);node(w);node(r.routes););out;"
...
PTNA_WWW_REGION_NAME="Landkreise Mainz-Bingen, Alzey-Worms, Bad Kreuznach, Birkenfeld"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B(relation[boundary=public_transport][name='Rhein-Nahe Nahverkehrsverbund']%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Rhein-Nahe Nahverkehrsverbund"
PTNA_WWW_NETWORK_LINK="https://www.rnn.info/"
...
PTNA_WWW_ROUTES_NAME="RNN Linien"
