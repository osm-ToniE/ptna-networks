...
PTNA_WWW_REGION_NAME="Arrondissement de Saint-Benoît, La Réunion"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=[out%3Ajson][timeout%3A25]%3B(relation[wikidata='Q702279'][type%3Dboundary]%3B)%3Bout+body%3B%3E%3Bout+skel+qt%3B{{data%3Aoverpass%2Cserver%3D%2F%2Foverpass.openstreetmap.fr%2Fapi%2F}}"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Estival"
PTNA_WWW_NETWORK_LINK="https://www.estival.re/"
...
PTNA_WWW_ROUTES_NAME="Lignes Estival"
