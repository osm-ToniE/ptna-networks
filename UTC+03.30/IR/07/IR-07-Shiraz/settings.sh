...
PTNA_EXTRACT_GETIDS="level4-IR-state-07"

OVERPASS_QUERY="https://overpass-api.de/api/interpreter?data=area[wikidata='Q6397066'][type=boundary];(rel(area)[~'route'~'(coach|bus|tram|train|subway|light_rail|trolleybus|ferry|monorail|aerialway|share_taxi|funicular)'];rel(br);rel[type=%27route%27](r);)-%3E.routes;(.routes;%3C%3C;rel(r.routes);way(r);node(w);way(r.routes);node(w);node(r.routes););out;"
NETWORK_LONG=""
NETWORK_SHORT=""

ANALYSIS_PAGE="Shiraz/Public_Transport/Analysis"
ANALYSIS_TALK="Talk:Shiraz/Public_Transport/Analysis"
WIKI_ROUTES_PAGE="Shiraz/Public_Transport/Analysis/Routes"
...
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B(relation[wikidata='Q6397066'][type=boundary]%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B"
