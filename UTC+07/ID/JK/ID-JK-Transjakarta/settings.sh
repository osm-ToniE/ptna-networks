...
PREFIX="ID-JK-Transjakarta"

PTNA_TIMEZONE="Asia/Jakarta"
...
PTNA_EXTRACT_GETIDS="level3-id-state-java"
...
PTNA_WWW_REGION_NAME="Daerah Khusus Ibukota Jakarta, Banten, Jawa Barat"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B(relation[wikidata~'^(Q3630|Q3540|Q3724)$'][type=boundary]%3B)%3Bout%20body%3B%3E%3Bout%20skel%20qt%3B"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Transjakarta"
PTNA_WWW_NETWORK_LINK="https://www.transjakarta.co.id/"
...
PTNA_WWW_DISCUSSION_NAME="Diskusi"
PTNA_WWW_DISCUSSION_LINK="https://wiki.openstreetmap.org/wiki/$ANALYSIS_TALK"

# Name + Link to list of expected public ransport routes page (usually in OSM Wiki but can als be on GitHub)
PTNA_WWW_ROUTES_NAME="Transjakarta Rute"
