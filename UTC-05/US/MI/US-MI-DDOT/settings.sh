...
PTNA_EXTRACT_GETIDS="level0-us-state-MI"

OVERPASS_QUERY="https://overpass-api.de/api/interpreter?data=[timeout:900];area[wikidata~'^(Q430464|Q12439|Q1013717|Q1144544)$'];(rel(area)[~'route'~'(bus|tram|train|subway|light_rail|trolleybus|ferry|monorail|aerialway|share_taxi|funicular)'];rel(br);rel[type=%27route%27](r);)-%3E.routes;(.routes;%3C%3C;rel(r.routes);way(r);node(w);way(r.routes);node(w);node(r.routes););out;"
NETWORK_LONG="Detroit Department of Transportation"
NETWORK_SHORT="DDOT"
...
PTNA_WWW_REGION_NAME="Detroit area (Dearborn, Detroit, Hamtramck, Highland Park), Michigan"
PTNA_WWW_REGION_LINK="https://overpass-turbo.eu/map.html?Q=%0A%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3B%0A%0A(%0A%0A%20%20relation%5Bwikidata~'^(Q430464|Q12439|Q1013717|Q1144544)$'%5D%3B%0A)%3B%0Aout%20body%3B%0A%3E%3B%0Aout%20skel%20qt%3B"

# Name + Link to the network provider / transport association
PTNA_WWW_NETWORK_NAME="Detroit Department of Transportation (DDOT)"
PTNA_WWW_NETWORK_LINK="https://detroitmi.gov/departments/detroit-department-transportation"
...
PTNA_WWW_ROUTES_NAME="DDOT Routes"
